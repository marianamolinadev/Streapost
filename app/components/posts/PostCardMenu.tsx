    ...
    <div className="relative">
      ...
      {menuOpen && (
        <>
          ...
          <div role="menu" className="absolute right-0 top-6 z-20 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg min-w-[120px] animate-dropdown-in">
            <button
              role="menuitem"
